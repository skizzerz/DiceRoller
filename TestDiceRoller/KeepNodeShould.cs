...
namespace TestDiceRoller
{
    ...
    public class KeepNodeShould : TestBase
    {
        ...
        public void Successfully_DropHighest()
        {
            ...
            EvaluateNode(node, StatConf, 4, "4d6.dropHighest(1) => 5 + 3 + 6!* + 1! => 9");
        }
        ...
        public void Successfully_DropLowest()
        {
            ...
            EvaluateNode(node, StatConf, 4, "4d6.dropLowest(1) => 5 + 3 + 6! + 1!* => 14");
        }
        ...
        public void Successfully_KeepHighest()
        {
            ...
            EvaluateNode(node, StatConf, 4, "4d6.keepHighest(1) => 5* + 3* + 6! + 1!* => 6");
        }
        ...
        public void Successfully_KeepLowest()
        {
            ...
            EvaluateNode(node, StatConf, 4, "4d6.keepLowest(1) => 5* + 3* + 6!* + 1! => 1");
        }
        ...
        public void Successfully_ApplyAdvantage()
        {
            ...
            EvaluateNode(node, AdvantageConf, 2, "1d20.advantage() => 2* + 19 => 19");
        }
