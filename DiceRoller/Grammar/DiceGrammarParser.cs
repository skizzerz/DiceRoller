...
public partial class DiceGrammarParser : Parser {
	...
	public partial class GlobalFunctionDPrefixContext : Global_functionContext {
		public ITerminalNode T_D() { return GetToken(DiceGrammarParser.T_D, 0); }
		public ITerminalNode AB_FUNCTION() { return GetToken(DiceGrammarParser.AB_FUNCTION, 0); }
		public ITerminalNode T_RPAREN() { return GetToken(DiceGrammarParser.T_RPAREN, 0); }
		public Function_argContext[] function_arg() {
			return GetRuleContexts<Function_argContext>();
		}
	...
	public partial class GroupFunctionContext : Group_functionContext {
		public ITerminalNode T_DOT_IDENTIFIER() { return GetToken(DiceGrammarParser.T_DOT_IDENTIFIER, 0); }
		public ITerminalNode T_LPAREN() { return GetToken(DiceGrammarParser.T_LPAREN, 0); }
		public ITerminalNode T_RPAREN() { return GetToken(DiceGrammarParser.T_RPAREN, 0); }
		public Function_argContext[] function_arg() {
			return GetRuleContexts<Function_argContext>();
	...
	public Group_functionContext group_function() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 189; Match(T_DOT_IDENTIFIER);
			State = 190; Match(T_LPAREN);
			State = 199;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T_GLOBAL_IDENTIFIER) | (1L << T_NUMBER) | (1L << T_MACRO) | (1L << T_EQUALS) | (1L << T_GREATER) | (1L << T_LESS) | (1L << T_GREATER_EQUALS) | (1L << T_LESS_EQUALS) | (1L << T_NOT_EQUALS) | (1L << T_LPAREN) | (1L << T_LBRACE) | (1L << T_MINUS) | (1L << T_D))) != 0)) {
	...
	public Basic_functionContext basic_function() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 203; Match(T_DOT_IDENTIFIER);
			State = 204; Match(T_LPAREN);
			State = 213;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T_GLOBAL_IDENTIFIER) | (1L << T_NUMBER) | (1L << T_MACRO) | (1L << T_EQUALS) | (1L << T_GREATER) | (1L << T_LESS) | (1L << T_GREATER_EQUALS) | (1L << T_LESS_EQUALS) | (1L << T_NOT_EQUALS) | (1L << T_LPAREN) | (1L << T_LBRACE) | (1L << T_MINUS) | (1L << T_D))) != 0)) {
				{
				State = 205; function_arg();
				State = 210;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				while (_la==T_COMMA) {
					{
					{
					State = 206; Match(T_COMMA);
					State = 207; function_arg();
					}
					}
					State = 212;
					ErrorHandler.Sync(this);
	...
	public Function_argContext function_arg() {
		...
		try {
			...
			case T_NOT_EQUALS:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 218; explicit_compare_expr();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Keep_exprContext keep_expr() {
		...
		try {
			...
			case T_KEEP_HIGH:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 246; Match(T_KEEP_HIGH);
				State = 247; unary_expr();
				}
				break;
			case T_KEEP_LOW:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 248; Match(T_KEEP_LOW);
				State = 249; unary_expr();
				}
				break;
			case T_DROP_HIGH:
				...
				EnterOuterAlt(_localctx, 3);
				{
				State = 250; Match(T_DROP_HIGH);
				State = 251; unary_expr();
				}
				break;
			case T_DROP_LOW:
				...
				EnterOuterAlt(_localctx, 4);
				{
				State = 252; Match(T_DROP_LOW);
				State = 253; unary_expr();
				}
				break;
			case T_ADVANTAGE:
			...
			case T_DISADVANTAGE:
				...
				EnterOuterAlt(_localctx, 6);
				{
				State = 255; Match(T_DISADVANTAGE);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Reroll_exprContext reroll_expr() {
		...
		try {
			...
			case T_REROLL:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 258; Match(T_REROLL);
				State = 259; compare_expr();
				}
				break;
			case T_REROLL_ONCE:
	...
	public Explode_exprContext explode_expr() {
		...
		try {
			...
			case T_COMPOUND:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 268; Match(T_COMPOUND);
				State = 270;
				ErrorHandler.Sync(this);
				switch ( Interpreter.AdaptivePredict(TokenStream,35,Context) ) {
				case 1:
					{
					State = 269; compare_expr();
					}
					break;
				}
				}
			...
			case T_PENETRATE:
				...
				EnterOuterAlt(_localctx, 3);
				{
				State = 272; Match(T_PENETRATE);
				State = 274;
				ErrorHandler.Sync(this);
				switch ( Interpreter.AdaptivePredict(TokenStream,36,Context) ) {
				case 1:
					{
					State = 273; compare_expr();
					}
					break;
				}
				}
	...
	public Success_exprContext success_expr() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 278; explicit_compare_expr();
			State = 281;
			ErrorHandler.Sync(this);
			switch ( Interpreter.AdaptivePredict(TokenStream,38,Context) ) {
			case 1:
				{
				State = 279; Match(T_FAIL);
				State = 280; compare_expr();
				}
				break;
			}
			}
	...
	public Compare_exprContext compare_expr() {
		...
		try {
			...
			case T_NOT_EQUALS:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 284; explicit_compare_expr();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Explicit_compare_exprContext explicit_compare_expr() {
		...
		try {
			...
			case T_EQUALS:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 287; Match(T_EQUALS);
				State = 288; unary_expr();
				}
				break;
			case T_GREATER:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 289; Match(T_GREATER);
				State = 290; unary_expr();
				}
				break;
			case T_LESS:
				...
				EnterOuterAlt(_localctx, 3);
				{
				State = 291; Match(T_LESS);
				State = 292; unary_expr();
				}
				break;
			case T_GREATER_EQUALS:
				...
				EnterOuterAlt(_localctx, 4);
				{
				State = 293; Match(T_GREATER_EQUALS);
				State = 294; unary_expr();
				}
				break;
			case T_LESS_EQUALS:
				...
				EnterOuterAlt(_localctx, 5);
				{
				State = 295; Match(T_LESS_EQUALS);
				State = 296; unary_expr();
				}
				break;
			case T_NOT_EQUALS:
				...
				EnterOuterAlt(_localctx, 6);
				{
				State = 297; Match(T_NOT_EQUALS);
				State = 298; unary_expr();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Crit_exprContext crit_expr() {
		...
		try {
			...
			case T_CRIT:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 305; Match(T_CRIT);
				State = 306; compare_expr();
				State = 309;
				ErrorHandler.Sync(this);
				switch ( Interpreter.AdaptivePredict(TokenStream,42,Context) ) {
				case 1:
					{
					State = 307; Match(T_FAIL);
					State = 308; compare_expr();
					}
					break;
				}
				}
			...
			case T_CRITFAIL:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 311; Match(T_CRITFAIL);
				State = 312; compare_expr();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	private static char[] _serializedATN = {
		...
		'\r', '\a', '\r', '\xD3', '\n', '\r', '\f', '\r', '\xE', '\r', '\xD6', 
		'\v', '\r', '\x5', '\r', '\xD8', '\n', '\r', '\x3', '\r', '\x3', '\r', 
		'\x3', '\xE', '\x3', '\xE', '\x5', '\xE', '\xDE', '\n', '\xE', '\x3', 
		'\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', 
		'\xF', '\a', '\xF', '\xE6', '\n', '\xF', '\f', '\xF', '\xE', '\xF', '\xE9', 
		'\v', '\xF', '\x3', '\x10', '\x3', '\x10', '\x3', '\x10', '\x3', '\x10', 
		'\x5', '\x10', '\xEF', '\n', '\x10', '\x3', '\x11', '\x3', '\x11', '\x3', 
		'\x11', '\x3', '\x11', '\x3', '\x11', '\x3', '\x11', '\x5', '\x11', '\xF7', 
		'\n', '\x11', '\x3', '\x12', '\x3', '\x12', '\x3', '\x12', '\x3', '\x12', 
		'\x3', '\x12', '\x3', '\x12', '\x3', '\x12', '\x3', '\x12', '\x3', '\x12', 
		'\x3', '\x12', '\x5', '\x12', '\x103', '\n', '\x12', '\x3', '\x13', '\x3', 
		'\x13', '\x3', '\x13', '\x3', '\x13', '\x5', '\x13', '\x109', '\n', '\x13', 
		'\x3', '\x14', '\x3', '\x14', '\x5', '\x14', '\x10D', '\n', '\x14', '\x3', 
		'\x14', '\x3', '\x14', '\x5', '\x14', '\x111', '\n', '\x14', '\x3', '\x14', 
		'\x3', '\x14', '\x5', '\x14', '\x115', '\n', '\x14', '\x5', '\x14', '\x117', 
		'\n', '\x14', '\x3', '\x15', '\x3', '\x15', '\x3', '\x15', '\x5', '\x15', 
		'\x11C', '\n', '\x15', '\x3', '\x16', '\x3', '\x16', '\x5', '\x16', '\x120', 
		'\n', '\x16', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', 
		'\x3', '\x17', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', 
		'\x3', '\x17', '\x3', '\x17', '\x3', '\x17', '\x5', '\x17', '\x12E', '\n', 
		'\x17', '\x3', '\x18', '\x3', '\x18', '\x5', '\x18', '\x132', '\n', '\x18', 
		'\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\x5', '\x19', 
		'\x138', '\n', '\x19', '\x3', '\x19', '\x3', '\x19', '\x5', '\x19', '\x13C', 
		'\n', '\x19', '\x3', '\x19', '\x2', '\x5', '\x6', '\b', '\x1C', '\x1A', 
		'\x2', '\x4', '\x6', '\b', '\n', '\f', '\xE', '\x10', '\x12', '\x14', 
		'\x16', '\x18', '\x1A', '\x1C', '\x1E', ' ', '\"', '$', '&', '(', '*', 
		',', '.', '\x30', '\x2', '\x2', '\x2', '\x163', '\x2', '\x32', '\x3', 
		'\x2', '\x2', '\x2', '\x4', '\x35', '\x3', '\x2', '\x2', '\x2', '\x6', 
		'\x37', '\x3', '\x2', '\x2', '\x2', '\b', '\x45', '\x3', '\x2', '\x2', 
		'\x2', '\n', '\x8B', '\x3', '\x2', '\x2', '\x2', '\f', '\x91', '\x3', 
		'\x2', '\x2', '\x2', '\xE', '\x96', '\x3', '\x2', '\x2', '\x2', '\x10', 
		'\x9D', '\x3', '\x2', '\x2', '\x2', '\x12', '\xA1', '\x3', '\x2', '\x2', 
		'\x2', '\x14', '\xBD', '\x3', '\x2', '\x2', '\x2', '\x16', '\xBF', '\x3', 
		'\x2', '\x2', '\x2', '\x18', '\xCD', '\x3', '\x2', '\x2', '\x2', '\x1A', 
		'\xDD', '\x3', '\x2', '\x2', '\x2', '\x1C', '\xDF', '\x3', '\x2', '\x2', 
		'\x2', '\x1E', '\xEE', '\x3', '\x2', '\x2', '\x2', ' ', '\xF6', '\x3', 
		...
		'\x5', '\x2', '\x2', ';', '<', '\a', '\x12', '\x2', '\x2', '<', '\x41', 
		'\x5', '\b', '\x5', '\x2', '=', '>', '\f', '\x4', '\x2', '\x2', '>', '?', 
		'\a', '\x13', '\x2', '\x2', '?', '\x41', '\x5', '\b', '\x5', '\x2', '@', 
		...
		'\x2', 'I', 'J', '\a', '\x14', '\x2', '\x2', 'J', 'O', '\x5', '\n', '\x6', 
		'\x2', 'K', 'L', '\f', '\x4', '\x2', '\x2', 'L', 'M', '\a', '\x15', '\x2', 
		'\x2', 'M', 'O', '\x5', '\n', '\x6', '\x2', 'N', 'H', '\x3', '\x2', '\x2', 
		...
		'\x2', '\x8D', '\x8E', '\a', '\x13', '\x2', '\x2', '\x8E', '\x92', '\x5', 
		...
		'\x94', '\a', '\x13', '\x2', '\x2', '\x94', '\x97', '\x5', '\x10', '\t', 
		...
		'\x2', '\xAE', '\xAF', '\x3', '\x2', '\x2', '\x2', '\xAF', '\xBE', '\a', 
		'\xE', '\x2', '\x2', '\xB0', '\xB1', '\a', '\x16', '\x2', '\x2', '\xB1', 
		'\xBA', '\a', '*', '\x2', '\x2', '\xB2', '\xB7', '\x5', '\x1A', '\xE', 
		'\x2', '\xB3', '\xB4', '\a', '\x11', '\x2', '\x2', '\xB4', '\xB6', '\x5', 
		'\x1A', '\xE', '\x2', '\xB5', '\xB3', '\x3', '\x2', '\x2', '\x2', '\xB6', 
		...
		'\xE', '\x2', '\x2', '\xBD', '\xA3', '\x3', '\x2', '\x2', '\x2', '\xBD', 
		'\xB0', '\x3', '\x2', '\x2', '\x2', '\xBE', '\x15', '\x3', '\x2', '\x2', 
		'\x2', '\xBF', '\xC0', '\a', '\x3', '\x2', '\x2', '\xC0', '\xC9', '\a', 
		'\r', '\x2', '\x2', '\xC1', '\xC6', '\x5', '\x1A', '\xE', '\x2', '\xC2', 
		'\xC3', '\a', '\x11', '\x2', '\x2', '\xC3', '\xC5', '\x5', '\x1A', '\xE', 
		...
		'\xCB', '\x3', '\x2', '\x2', '\x2', '\xCB', '\xCC', '\a', '\xE', '\x2', 
		'\x2', '\xCC', '\x17', '\x3', '\x2', '\x2', '\x2', '\xCD', '\xCE', '\a', 
		'\x3', '\x2', '\x2', '\xCE', '\xD7', '\a', '\r', '\x2', '\x2', '\xCF', 
		'\xD4', '\x5', '\x1A', '\xE', '\x2', '\xD0', '\xD1', '\a', '\x11', '\x2', 
		'\x2', '\xD1', '\xD3', '\x5', '\x1A', '\xE', '\x2', '\xD2', '\xD0', '\x3', 
		'\x2', '\x2', '\x2', '\xD3', '\xD6', '\x3', '\x2', '\x2', '\x2', '\xD4', 
		'\xD2', '\x3', '\x2', '\x2', '\x2', '\xD4', '\xD5', '\x3', '\x2', '\x2', 
		'\x2', '\xD5', '\xD8', '\x3', '\x2', '\x2', '\x2', '\xD6', '\xD4', '\x3', 
		'\x2', '\x2', '\x2', '\xD7', '\xCF', '\x3', '\x2', '\x2', '\x2', '\xD7', 
		'\xD8', '\x3', '\x2', '\x2', '\x2', '\xD8', '\xD9', '\x3', '\x2', '\x2', 
		'\x2', '\xD9', '\xDA', '\a', '\xE', '\x2', '\x2', '\xDA', '\x19', '\x3', 
		'\x2', '\x2', '\x2', '\xDB', '\xDE', '\x5', '\x4', '\x3', '\x2', '\xDC', 
		'\xDE', '\x5', ',', '\x17', '\x2', '\xDD', '\xDB', '\x3', '\x2', '\x2', 
		'\x2', '\xDD', '\xDC', '\x3', '\x2', '\x2', '\x2', '\xDE', '\x1B', '\x3', 
		'\x2', '\x2', '\x2', '\xDF', '\xE0', '\b', '\xF', '\x1', '\x2', '\xE0', 
		'\xE1', '\x5', '\x4', '\x3', '\x2', '\xE1', '\xE7', '\x3', '\x2', '\x2', 
		'\x2', '\xE2', '\xE3', '\f', '\x4', '\x2', '\x2', '\xE3', '\xE4', '\a', 
		'\x11', '\x2', '\x2', '\xE4', '\xE6', '\x5', '\x4', '\x3', '\x2', '\xE5', 
		'\xE2', '\x3', '\x2', '\x2', '\x2', '\xE6', '\xE9', '\x3', '\x2', '\x2', 
		'\x2', '\xE7', '\xE5', '\x3', '\x2', '\x2', '\x2', '\xE7', '\xE8', '\x3', 
		'\x2', '\x2', '\x2', '\xE8', '\x1D', '\x3', '\x2', '\x2', '\x2', '\xE9', 
		'\xE7', '\x3', '\x2', '\x2', '\x2', '\xEA', '\xEF', '\x5', '\"', '\x12', 
		'\x2', '\xEB', '\xEF', '\x5', '(', '\x15', '\x2', '\xEC', '\xEF', '\x5', 
		'.', '\x18', '\x2', '\xED', '\xEF', '\x5', '$', '\x13', '\x2', '\xEE', 
		'\xEA', '\x3', '\x2', '\x2', '\x2', '\xEE', '\xEB', '\x3', '\x2', '\x2', 
		'\x2', '\xEE', '\xEC', '\x3', '\x2', '\x2', '\x2', '\xEE', '\xED', '\x3', 
		'\x2', '\x2', '\x2', '\xEF', '\x1F', '\x3', '\x2', '\x2', '\x2', '\xF0', 
		'\xF7', '\x5', '$', '\x13', '\x2', '\xF1', '\xF7', '\x5', '&', '\x14', 
		'\x2', '\xF2', '\xF7', '\x5', '\"', '\x12', '\x2', '\xF3', '\xF7', '\x5', 
		'(', '\x15', '\x2', '\xF4', '\xF7', '\x5', '.', '\x18', '\x2', '\xF5', 
		'\xF7', '\x5', '\x30', '\x19', '\x2', '\xF6', '\xF0', '\x3', '\x2', '\x2', 
		...
		'\x19', '\x2', '\x2', '\xF9', '\x103', '\x5', '\xE', '\b', '\x2', '\xFA', 
		'\xFB', '\a', '\x1A', '\x2', '\x2', '\xFB', '\x103', '\x5', '\xE', '\b', 
		'\x2', '\xFC', '\xFD', '\a', '\x1B', '\x2', '\x2', '\xFD', '\x103', '\x5', 
		'\xE', '\b', '\x2', '\xFE', '\xFF', '\a', '\x1C', '\x2', '\x2', '\xFF', 
		'\x103', '\x5', '\xE', '\b', '\x2', '\x100', '\x103', '\a', '\x1D', '\x2', 
		'\x2', '\x101', '\x103', '\a', '\x1E', '\x2', '\x2', '\x102', '\xF8', 
		'\x3', '\x2', '\x2', '\x2', '\x102', '\xFA', '\x3', '\x2', '\x2', '\x2', 
		'\x102', '\xFC', '\x3', '\x2', '\x2', '\x2', '\x102', '\xFE', '\x3', '\x2', 
		'\x2', '\x2', '\x102', '\x100', '\x3', '\x2', '\x2', '\x2', '\x102', '\x101', 
		'\x3', '\x2', '\x2', '\x2', '\x103', '#', '\x3', '\x2', '\x2', '\x2', 
		'\x104', '\x105', '\a', '\x1F', '\x2', '\x2', '\x105', '\x109', '\x5', 
		'*', '\x16', '\x2', '\x106', '\x107', '\a', ' ', '\x2', '\x2', '\x107', 
		'\x109', '\x5', '*', '\x16', '\x2', '\x108', '\x104', '\x3', '\x2', '\x2', 
		'\x2', '\x108', '\x106', '\x3', '\x2', '\x2', '\x2', '\x109', '%', '\x3', 
		'\x2', '\x2', '\x2', '\x10A', '\x10C', '\a', '!', '\x2', '\x2', '\x10B', 
		'\x10D', '\x5', '*', '\x16', '\x2', '\x10C', '\x10B', '\x3', '\x2', '\x2', 
		'\x2', '\x10C', '\x10D', '\x3', '\x2', '\x2', '\x2', '\x10D', '\x117', 
		'\x3', '\x2', '\x2', '\x2', '\x10E', '\x110', '\a', '\"', '\x2', '\x2', 
		'\x10F', '\x111', '\x5', '*', '\x16', '\x2', '\x110', '\x10F', '\x3', 
		'\x2', '\x2', '\x2', '\x110', '\x111', '\x3', '\x2', '\x2', '\x2', '\x111', 
		'\x117', '\x3', '\x2', '\x2', '\x2', '\x112', '\x114', '\a', '#', '\x2', 
		'\x2', '\x113', '\x115', '\x5', '*', '\x16', '\x2', '\x114', '\x113', 
		'\x3', '\x2', '\x2', '\x2', '\x114', '\x115', '\x3', '\x2', '\x2', '\x2', 
		'\x115', '\x117', '\x3', '\x2', '\x2', '\x2', '\x116', '\x10A', '\x3', 
		'\x2', '\x2', '\x2', '\x116', '\x10E', '\x3', '\x2', '\x2', '\x2', '\x116', 
		'\x112', '\x3', '\x2', '\x2', '\x2', '\x117', '\'', '\x3', '\x2', '\x2', 
		'\x2', '\x118', '\x11B', '\x5', ',', '\x17', '\x2', '\x119', '\x11A', 
		'\a', '&', '\x2', '\x2', '\x11A', '\x11C', '\x5', '*', '\x16', '\x2', 
		'\x11B', '\x119', '\x3', '\x2', '\x2', '\x2', '\x11B', '\x11C', '\x3', 
		'\x2', '\x2', '\x2', '\x11C', ')', '\x3', '\x2', '\x2', '\x2', '\x11D', 
		'\x120', '\x5', '\xE', '\b', '\x2', '\x11E', '\x120', '\x5', ',', '\x17', 
		'\x2', '\x11F', '\x11D', '\x3', '\x2', '\x2', '\x2', '\x11F', '\x11E', 
		'\x3', '\x2', '\x2', '\x2', '\x120', '+', '\x3', '\x2', '\x2', '\x2', 
		'\x121', '\x122', '\a', '\a', '\x2', '\x2', '\x122', '\x12E', '\x5', '\xE', 
		'\b', '\x2', '\x123', '\x124', '\a', '\b', '\x2', '\x2', '\x124', '\x12E', 
		'\x5', '\xE', '\b', '\x2', '\x125', '\x126', '\a', '\t', '\x2', '\x2', 
		'\x126', '\x12E', '\x5', '\xE', '\b', '\x2', '\x127', '\x128', '\a', '\n', 
		'\x2', '\x2', '\x128', '\x12E', '\x5', '\xE', '\b', '\x2', '\x129', '\x12A', 
		'\a', '\v', '\x2', '\x2', '\x12A', '\x12E', '\x5', '\xE', '\b', '\x2', 
		'\x12B', '\x12C', '\a', '\f', '\x2', '\x2', '\x12C', '\x12E', '\x5', '\xE', 
		'\b', '\x2', '\x12D', '\x121', '\x3', '\x2', '\x2', '\x2', '\x12D', '\x123', 
		'\x3', '\x2', '\x2', '\x2', '\x12D', '\x125', '\x3', '\x2', '\x2', '\x2', 
		'\x12D', '\x127', '\x3', '\x2', '\x2', '\x2', '\x12D', '\x129', '\x3', 
		'\x2', '\x2', '\x2', '\x12D', '\x12B', '\x3', '\x2', '\x2', '\x2', '\x12E', 
		'-', '\x3', '\x2', '\x2', '\x2', '\x12F', '\x132', '\a', '\'', '\x2', 
		'\x2', '\x130', '\x132', '\a', '(', '\x2', '\x2', '\x131', '\x12F', '\x3', 
		'\x2', '\x2', '\x2', '\x131', '\x130', '\x3', '\x2', '\x2', '\x2', '\x132', 
		'/', '\x3', '\x2', '\x2', '\x2', '\x133', '\x134', '\a', '$', '\x2', '\x2', 
		'\x134', '\x137', '\x5', '*', '\x16', '\x2', '\x135', '\x136', '\a', '&', 
		'\x2', '\x2', '\x136', '\x138', '\x5', '*', '\x16', '\x2', '\x137', '\x135', 
		'\x3', '\x2', '\x2', '\x2', '\x137', '\x138', '\x3', '\x2', '\x2', '\x2', 
		'\x138', '\x13C', '\x3', '\x2', '\x2', '\x2', '\x139', '\x13A', '\a', 
		'%', '\x2', '\x2', '\x13A', '\x13C', '\x5', '*', '\x16', '\x2', '\x13B', 
		'\x133', '\x3', '\x2', '\x2', '\x2', '\x13B', '\x139', '\x3', '\x2', '\x2', 
		'\x2', '\x13C', '\x31', '\x3', '\x2', '\x2', '\x2', '.', '@', '\x42', 
		'N', 'P', 'T', '\\', '\x62', '\x66', 'm', 's', 'w', '|', '\x81', '\x87', 
		'\x8B', '\x91', '\x96', '\x9D', '\xA1', '\xAA', '\xAD', '\xB7', '\xBA', 
		'\xBD', '\xC6', '\xC9', '\xD4', '\xD7', '\xDD', '\xE7', '\xEE', '\xF6', 
		'\x102', '\x108', '\x10C', '\x110', '\x114', '\x116', '\x11B', '\x11F', 
		'\x12D', '\x131', '\x137', '\x13B',
	};
