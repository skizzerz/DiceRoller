...
namespace Dice.Grammar
{
    public class DiceGrammarListener : DiceGrammarBaseListener
    {
        ...
        public override void ExitBasicBasic([NotNull] DiceGrammarParser.BasicBasicContext context)
        {
        ...
        public override void ExitBasicFudge([NotNull] DiceGrammarParser.BasicFudgeContext context)
        {
